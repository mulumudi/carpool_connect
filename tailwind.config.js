  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'ambient': '0 0 0 1px rgb(191 219 254), 0 0 8px rgba(37, 99, 235, 0.15)',
        'ambient-success': '0 0 0 1px rgb(167 243 208), 0 0 8px rgba(16, 185, 129, 0.15)',
        'ambient-warning': '0 0 0 1px rgb(253 230 138), 0 0 8px rgba(245, 158, 11, 0.15)',
        'ambient-error': '0 0 0 1px rgb(254 202 202), 0 0 8px rgba(239, 68, 68, 0.15)',
      },
      animation: {
